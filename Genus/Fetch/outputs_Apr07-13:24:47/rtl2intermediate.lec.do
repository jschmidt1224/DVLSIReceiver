...
usage -auto -elapse
set log file logs_Apr07-13:24:47/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design   -define SYNTHESIS  -golden -lastmod -noelab -verilog2k \
	/afs/ee.cooper.edu/user/k/u/kurutu/Digital_VLSI/DVLSIReceiver/RTL/DSPFetch.v
} else {
...
elaborate design -golden -root DSPFetch -rootonly
