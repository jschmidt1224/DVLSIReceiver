...
if {$_slk_ != "-248.8"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: -248.8,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_tns_ != "118221"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden tns: 118221,  current tns: $_tns_"
}
unset _tns_
# cell area
...
if {$_cell_area_ != "26826"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 26826,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "11316"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 11316,  current net area: $_net_area_"
}
unset _net_area_
